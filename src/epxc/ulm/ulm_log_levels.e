...
feature -- Log levels, values for the LVL field
	...
	Security,
		-- A standard protection was raised against what could be an intrusion.
	Usage,
		-- Normal, standard, authorized day-to-day usage information.
	System_usage,
		-- Tangible usage, but not treaceable to any user. Because of
		-- class with SmallEiffel's GENERAL, it is not just called
		-- System.
	Important,
