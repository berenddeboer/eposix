...
feature -- Redirection codes
	...
	reply_code_moved_permanently: INTEGER = 301
	...
	reply_code_see_other: INTEGER = 303
	...
	reply_code_not_modified: INTEGER = 304
	...
	reply_code_use_proxy: INTEGER = 305
			-- The requested resource MUST be accessed through the proxy
			-- given by the Location field. The Location field gives the
			-- URI of the proxy.

	reply_code_temporary_redirect: INTEGER = 307
			-- The requested resource resides temporarily under a
...
feature -- Server error codes
	...
	reply_code_service_unavailable: INTEGER = 503
